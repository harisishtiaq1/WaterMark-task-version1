import { Container, List, ListItem, Toolbar, Typography } from "@mui/material";
    ...
    <div>
      <Container>
        ...
        <Typography variant="h6">
          Madison Interactive built the Watermark app as a Freemium app. This
          SERVICE is provided by Madison Interactive at no cost and is intended
          for use as is. <br />
          <br />
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service. <br />
          <br />
          ...
          Terms and Conditions, which is accessible at Watermark unless
        ...
        <Typography variant="h6">
          ...
          including but not limited to email address, gender, ethnicity. The
        ...
        <Container>
          <List sx={{ listStyleType: "disc" }}>
            <ListItem sx={{ display: "list-item" }}>
              <Link>Google Play Services</Link>
            </ListItem>
          </List>
        </Container>
        <Toolbar />
        ...
        <Typography variant="h6">
          ...
          <br /> info@madisoninteractive.com.au
        </Typography>
        <Toolbar />
      </Container>
      <Terms />
