    ...
    <div>
      <Container>
        ...
        <Typography variant="h6">
          ...
          related to it, still belong to Madison Interactive. <br />
          <br />
          Madison Interactive is committed to ensuring that the app is as useful
          ...
          <br />
          <br />
          The WaterMark app stores and processes personal data that you have
          ...
          WaterMark app won’t work properly or at all. <br />
          <br />
          You should be aware that there are certain things that Madison
          Interactive will not take responsibility for. Certain functions of the
          ...
          but Madison Interactive cannot take responsibility for the app not
          working at full functionality if you don’t have access to Wi-Fi, and
          you don’t have any of your data allowance left. <br />
          <br />
          ...
          <br />
          <br />
          Along the same lines, Madison Interactive cannot always take
          ...
          can’t turn it on to avail the Service, Madison Interactive cannot
          accept responsibility <br />
          <br />
          With respect to Madison Interactive’s responsibility for your use of
          ...
          that we can make it available to you. Madison Interactive accepts no
          liability for any loss, direct or indirect, you experience as a result
          of relying wholly on this functionality of the app. <br />
          <br />
          At some point, we may wish to update the app. The app is currently
          available on Android and iOS – the requirements for both systems (and
          ...
          want to keep using the app. Madison Interactive does not promise that
          it will always update the app so that it is relevant to you and/or
          works with the iOS/Android version that you have installed on your
        ...
        <Typography variant="h6">
          ...
          info@madisoninteractive.com.au
        </Typography>
        <Toolbar />
      </Container>
    </div>
